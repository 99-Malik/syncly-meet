...
interface EditGroupModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSaveChanges?: (data: { title: string; description: string; members: Member[] }) => void;
    initialData?: {
        title: string;
        description: string;
        members: Member[];
...
export const EditGroupModal: React.FC<EditGroupModalProps> = ({ 
    ...
    const [addedMembers, setAddedMembers] = useState<Member[]>(initialData?.members || [
    ...
    useEffect(() => {
        if (initialData) {
            ...
            setAddedMembers(initialData.members || []);
        }
    }, [initialData]);
