...
const IntegrationHome = () => {
    const [integrations, setIntegrations] = useState<Integration[]>([
        { id: "1", title: "Google account", email: "www.user123@gmail.com" },
        { id: "2", title: "Google account", email: "www.user123@gmail.com" },
        { id: "3", title: "Google account", email: "www.user123@gmail.com" },
        { id: "4", title: "Google account", email: "www.user123@gmail.com" },
    ]);
