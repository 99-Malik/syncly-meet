...
export default function DashboardLayout({
  ...
  return (
    <div className={`${isAiChatPage ? "h-screen overflow-hidden" : "min-h-screen"} bg-[#f5f6f6] flex p-4`}>
      ...
      <div className={`flex-1 flex flex-col ${isAiChatPage ? "overflow-hidden min-h-0" : ""} ml-4 border rounded-2xl border-gray-200 bg-gradient-to-r from-white via-[#f8fbff] to-[#eef4fa] min-w-0`}>
        {/* Navbar */}
        <NavBar />
