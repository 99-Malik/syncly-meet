    ...
    <>
      <div className="bg-white rounded-2xl border border-[#E5E7EB] py-2 z-100 min-w-[200px]">
        ...
        >
          ...
          <span className="font-medium">Deleted Group</span>
        </button>
      </div>
      ...
      <DeleteModal
        ...
        subtitle="It will delete all your account details from this device and it will autologout session from your device"
