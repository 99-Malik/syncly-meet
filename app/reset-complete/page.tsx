...
import { SuccessModal } from "../../components/Sign-In/SuccessModal";
import { LockIcon, EyeIcon } from "../../components/Sign-In/Icons";
    ...
    <div className="min-h-screen flex flex-col lg:flex-row mx-auto p-5">
      ...
      <LeftColumn>
        ...
        <Heading 
          ...
          subtitle="Now you can reset your password here, enter new password to get login back." 
        />
        ...
        <div className="space-y-4">
          ...
          {/* Reset Login Button */}
          <LoginButton text="Reset Login" onClick={handleResetLogin} />
